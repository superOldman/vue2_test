;(this.webpackJsonp = this.webpackJsonp || []).push([
  [278],
  {
            ...
            ratio: function(t) {
              ...
              ;(this.show = !0),
                ...
                (this.timer = setTimeout(function() {
                  e.$store.commit('qiye/SET_ZOOM_SHOW', !1), (e.show = !1)
                }, 1e3))
            },
          },
        },
              ...
              ? n(
                  ...
                  [
                    n(
                      ...
                      [t._v(t._s(t.parseRatio(t.ratio)))]
                    ),
                  ]
                )
              : t._e()
    ...
    7275: function(t, e, n) {
      'use strict'
      n.r(e)
      n(24), n(14), n(17), n(23), n(21)
      var r,
        i = n(60),
        a = n(1),
        o = n(4),
        c = (n(32), n(15), n(19), n(85), n(86), n(45), n(33), n(1629)),
        d = n(16),
        s = n(2427),
        u = n(2249),
        l = n(2382),
      ...
      var m = {
          ...
          beforeDestroy: function() {
            this.SET_LOADSTATE(''), window.$nuxt.$off('company-diagram-relation-export', this.handleDownLoad)
          },
          components: {
            DiagramPopup: s.a,
            ZoomPopup: u.a,
              ...
              treeMap: function() {
                return r
                  ...
                  .separation(function(t, e) {
                    ...
                    if (n > 1) {
                      var r = 0
                      ;(r = t.children ? r + t.children.length : r), (n = (r = e.children ? r + e.children.length : r) / 2 + 1)
                    }
                    return n
                  })
              },
          ...
          methods: g(
            g({}, Object(p.mapMutations)('qiye', ['SET_LOADSTATE'])),
            {},
            {
              handleEdit: function() {
                ;(this.editActive = !this.editActive), (this.visibility = this.editActive ? 'visible' : 'hidden'), r.selectAll('.circle-remove').attr('visibility', this.visibility)
              },
              handleScale: function(t) {
                r.select('#svg svg')
                  .transition()
                  .call(this.d3Zoom.scaleBy, 'up' === t ? 1.1 : 0.9)
              },
              ...
              handleCenterNode: function(t) {
                ;(this.nodeClick = !0),
                  r
                    .select('#svg svg')
                    .transition()
                    .call(this.d3Zoom.translateTo, t.x0, t.y0)
              },
                    ...
                    return regeneratorRuntime.wrap(function(e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 3:
                            if (((r = e.sent), (i = r.success), (a = r.data), i)) {
                              e.next = 8
                              break
                            }
              ...
              initSvg: function() {
                ...
                ;(this.container = s
                  .append('g')
                  .attr('id', 'container')
                  .attr('transform', 'translate('.concat(i, ',').concat(t, ') scale(1)'))),
                  this.drawRoot()
                var u = r
                  .zoom()
                  .scaleExtent(this.scaleRange)
                  .on('zoom', this.zoomFn)
                ;(this.d3Zoom = u), s.call(u), this.dealData()
              },
              zoomFn: function(t) {
                this.nodeClick || (this.ratio = t.transform.k), this.container.attr('transform', t.transform)
              },
              drawRoot: function() {
                var t = this,
                ...
                ;(this.rootNodeHeight = 40), (this.rootNodeLength = n)
                var a = this.container
                  .append('g')
                  .attr('id', 'rootTitle')
                  .attr('transform', 'translate('.concat(this.centerPoint[0], ',').concat(this.centerPoint[1], ')'))
                  .attr('cursor', 'pointer')
                  .on('click', function() {
                    t.toDetail(r)
                  })
                ...
                a
                  ...
                  .attr('rx', 3)
                  .attr('width', n)
                  .attr('height', this.rootNodeHeight)
                  .attr('fill', '#3981F4'),
                  a
                    .append('text')
                ...
                this.directions.forEach(function(e) {
                  ;(t.root[e] = r.hierarchy(t.treeData[e])),
                    ...
                    t.root[e].descendants().forEach(function(n) {
                      ;(n.id = e + t.uuid()), (n._children = n.children), n.depth >= 1 && (n.children = null)
                    }),
                    t.update(t.root[e], e)
                })
              },
              update: function(t, e) {
                ...
                o.forEach(function(t) {
                  if (!t.depth && r > 0) return (t.x = t.x + n.centerPoint[0]), void (t.y = r * t.y + n.centerPoint[1] - n.textNodeHeight / 2)
                  ;(t.x = t.x + n.centerPoint[0]), (t.y = r * t.y + n.centerPoint[1])
                })
                var d = this.container.selectAll('g.'.concat(i)).data(o, function(t) {
                  ...
                  s = d
                    ...
                    .on('click', function(t, r) {
                      t.stopPropagation(), -1 === (null == r ? void 0 : r.data.type) ? n.addNodeByClick(r, e) : n.handleCenterNode(r)
                    })
                s.each(function(t) {
                  0 !== t.depth &&
                    (t.data.name.length <= 11 ? n.drawText('g'.concat(t.id), r, t) : n.drawTextMultiline('g'.concat(t.id), r),
              ...
              drawText: function(t, e, n) {
                var i,
                  a = this
                if (((e = e > 0), -1 === n.data.type && null !== (i = n.parent) && void 0 !== i && i.data.sourceChild)) {
                ...
                return r
                  ...
                  .on('mouseover', this.rectMo(!0))
                  .on('mouseout', this.rectMo(!1))
              },
              ...
              drawSubText: function(t, e) {
                ...
                i
                  ...
                  .attr('y', function(t) {
                    return e > 0
                      ? t.parent && t.parent.children.length > 1
                        ? -n.textNodeHeight - n.fontSize / 2
                        : (-n.nodeSize[1] - n.fontSize) / 2
                      : t.parent && t.parent.children.length > 1
                      ? n.textNodeHeight - n.fontSize / 2
                      : (n.nodeSize[1] - n.fontSize) / 2
                  })
                  ...
                  i
                    .insert('rect', 'text')
                    .attr('x', -this.subTextWidth / 2)
                    .attr('y', function(t) {
                      return e > 0
                        ? t.parent && t.parent.children.length > 1
                          ? -n.textNodeHeight - n.subTextHeight - n.fontSize / 8
                          : -n.nodeSize[1] / 2 - n.subTextHeight - n.fontSize / 8
                        : t.parent && t.parent.children.length > 1
                        ? n.textNodeHeight / 2 + n.fontSize / 2
                        : n.textNodeHeight - n.fontSize / 8
                    })
              ...
              drawTag: function(t, e) {
                ...
                i
                  ...
                  i
                    .insert('rect', 'text')
                    .attr('x', this.textNodeWidth / 3 - this.subTextWidth / 2)
                    .attr('y', function(t) {
                      return -n.textNodeHeight / 2 - n.fontSize
                    })
                    .attr('height', function(t) {
              ...
              diagonal: function(t, e) {
                var n,
                  ...
                  a = t.target
                return (
                  e > 0 && ((n = i.y + this.textNodeHeight / 2 + this.circleRadius + 4), (r = a.y - this.textNodeHeight / 2 - this.fontSize / 2 - 8)),
                  e < 0 && ((n = i.y - this.textNodeHeight / 2 - this.fontSize / 2 - 2 * this.circleRadius - 2), (r = a.y + this.textNodeHeight / 2 - this.fontSize / 2)),
                  a.depth <= 1 &&
                    (e > 0 && ((n = i.y + this.textNodeHeight / 2 + this.textNodeHeight / 2 - this.fontSize + 2), (r = a.y - this.textNodeHeight / 2 - this.fontSize / 2)),
                    e < 0 && ((n = i.y - this.textNodeHeight / 2 + 2), (r = a.y + this.textNodeHeight / 2 - this.fontSize / 2))),
                  'M '
                    .concat(i.x, ' ')
                    .concat(n, '\n                    L ')
                    .concat(i.x, ' ')
              ...
              drawRect: function(t, e, n) {
                ...
                var o = a
                  ...
                  .attr('transform', 'translate('.concat(this.textNodeWidth / 2, ',').concat(-this.textNodeHeight / 2 - this.circleRadius, ') rotate(45)'))
                  .attr('visibility', this.visibility)
                  .style('cursor', 'pointer')
                  .on('click', function(t, e) {
                    t.stopPropagation(), i.deleteNode(e, n)
                  })
                o
                  .append('circle')
                  .attr('cx', 0)
                  ...
                  o
                    .append('path')
                    .attr('d', 'm 0 -4 l 0 '.concat(8))
                    .attr('stroke-width', 1)
                    .attr('stroke', '#fff'),
                  o
                    .append('path')
                    .attr('d', 'm -4 0 l '.concat(8, ' 0'))
                    .attr('stroke-width', 1)
                    .attr('stroke', '#fff')
              },
              drawPopup: function(t, e) {
                var n = 36,
                  i = r
                    ...
                    .attr('transform', 'translate(0,'.concat(-this.textNodeHeight - 4, ')'))
                    .attr('fill', function(t) {
                ...
                i
                  ...
                  i
                    ...
                    .attr('transform', 'translate(0,'.concat(n / 2 + 4, ')'))
              },
              drawTriangle: function(t, e) {
                ...
                r.select('#'.concat(t))
                  ...
                  .attr('fill', '#3981f4')
                  .attr('transform', function(t) {
                    if (!t.depth) return 'translate(0,'.concat(-n.textNodeHeight / 2 + n.fontSize / 4, ')')
                    if (e > 0) return 'translate(0,'.concat(-n.textNodeHeight / 2 - n.fontSize / 2, ')')
                    var r = n.nodeSize[1]
                    return t.parent && t.parent.children.length > 1
                      ? 'translate(0,'.concat(r / 2, ')')
                      : 1 !== t.depth
                      ? 'translate(0,'.concat(-e * r - n.textNodeHeight + n.circleRadius, ')')
                      : 'translate(0,'.concat(-e * r - n.textNodeHeight / 2 + 3, ')')
                  })
                  .append('path')
                  .attr('d', function(t) {
              ...
              drawCircle: function(t, e) {
                var n = this,
                  ...
                  a = r
                    ...
                    .style('cursor', 'pointer')
                    .on('click', function(t, r) {
                      t.stopPropagation(), n.clickNode(r, e), n.handleCenterNode(r)
                    })
                return (
                  a
                    .append('circle')
              ...
              drawLineText: function(t, e, n) {
                ...
                o.append('text')
                  ...
                  .attr('y', function(t) {
                    return a > 0
                      ? t.depth <= 1 && t.parent && t.parent.children.length > 1
                        ? -i.textNodeHeight - i.fontSize / 2
                        : t.parent && t.parent.children.length > 1
                        ? -i.textNodeHeight
                        : (-i.nodeSize[1] - i.fontSize) / 2
                      : t.parent && t.parent.children.length > 1
                      ? i.textNodeHeight - i.fontSize / 2
                      : i.nodeSize[1] / 2 - i.fontSize / 2
                  })
                  .attr('fill', '#fff')
                  .style('font-size', this.fontSize)
                  .text(function(t) {
                ...
                o
                  ...
                  .attr('y', function(t) {
                    return a > 0
                      ? t.depth <= 1 && t.parent && t.parent.children.length > 1
                        ? -i.textNodeHeight - i.subTextHeight - i.fontSize / 8
                        : t.parent && t.parent.children.length > 1
                        ? -i.textNodeHeight - i.fontSize - i.fontSize / 8
                        : -i.nodeSize[1] / 2 - i.subTextHeight - i.fontSize / 8
                      : t.parent && t.parent.children.length > 1
                      ? i.textNodeHeight / 2 + i.fontSize / 2
                      : i.textNodeHeight - i.fontSize / 8 + i.fontSize - 2
                  })
                  .attr('rx', 2)
                  .attr('stroke', function(t) {
              ...
              drawDesc: function(t, e, n) {
                ...
                i
                  ...
                  .attr('y', function(t) {
                    return e > 0
                      ? t.depth <= 1 && t.parent && t.parent.children.length > 1
                        ? -r.textNodeHeight - r.fontSize / 2
                        : t.parent && t.parent.children.length > 1
                        ? -r.textNodeHeight
                        : (-r.nodeSize[1] - r.fontSize) / 2
                      : t.parent && t.parent.children.length > 1
                      ? r.textNodeHeight - r.fontSize / 2
                      : (r.nodeSize[1] - r.fontSize) / 2
                  })
                  ...
                  i
                    ...
                    .attr('y', function(t) {
                      return e > 0
                        ? t.depth <= 1 && t.parent && t.parent.children.length > 1
                          ? -r.textNodeHeight - r.subTextHeight - r.fontSize / 8
                          : t.parent && t.parent.children.length > 1
                          ? -r.textNodeHeight - r.fontSize - r.fontSize / 8
                          : -r.nodeSize[1] / 2 - r.subTextHeight - r.fontSize / 8
                        : t.parent && t.parent.children.length > 1
                        ? r.textNodeHeight / 2 + r.fontSize / 2
                        : r.textNodeHeight - r.fontSize / 8
                    })
                    .attr('rx', 2)
                    .attr('stroke', '#D4E5FF')
                    .attr('fill', '#D4E5FF')
                    ...
                    return regeneratorRuntime.wrap(function(i) {
                      for (;;)
                        switch ((i.prev = i.next)) {
                          ...
                          case 8:
                            if (((c = i.sent), (s = c.success), (u = c.data), (n.loading = !1), s)) {
                              i.next = 14
                              break
                            }
                            return i.abrupt('return')
                          case 14:
                            if (
                              (l = u.children.filter(function(e) {
                            ...
                            return r.select('#g'.concat(t.id, ' .node-circle')).attr('visibility', 'hidden'), i.abrupt('return')
                          case 18:
                          ...
                          case 25:
                            !a && (t.children = t.children ? null : t._children),
                              r
                                .select('#g'.concat(t.id, ' .node-circle .node-circle-vertical'))
                                .transition()
                                .duration(n.duration)
                                .attr('stroke-width', function(t) {
                                  return t.children ? 0 : 1
              ...
              deleteNode: function(t, e) {
                ...
                n &&
                  (1 === n.children.length
                    ? ((n.children = null), (n._children = null))
                    : ((n.children =
                        n.children.filter(function(e) {
                          return e.id !== t.id
                        }) || null),
                      (n._children =
                        n._children.filter(function(e) {
                          return e.id !== t.id
                        }) || null))),
              ...
              changeSourceData: function(t) {
                null != t &&
                  t.children &&
                  ((t.sourceChild = JSON.parse(JSON.stringify(t.children))),
                  (t.children = t.sourceChild.slice(0, 10)),
                  t.sourceChild.length > 10 &&
                    t.children.push({
                      type: -1,
                      name: '',
                    }))

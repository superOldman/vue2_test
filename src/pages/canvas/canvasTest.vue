...
export default {
  ...
  methods: {
    ...
    drawPeople(direction, imgPos) {
      ...
      this.ctx.drawImage(this.manBg, directionList[direction] + imgPos * this.manSize.x, directionList[direction], this.manSize.x, this.manSize.y, this.manX, this.manY, this.manSize.x, this.manSize.y)
    },
    control() {
